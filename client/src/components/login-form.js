				...
				<div style={loginStyle}>
					<div style={centeringAuth}>
						...
						<form>
							<label>
								User Name
								<input id="username" style={inputStyle} name="userName" type="test" onChange={this.handleUsernameAndPassChange} />
							</label>
							<br />
							<label>
								Password
								<input id="password" style={inputStyle} name="password" type="password" onChange={this.handleUsernameAndPassChange} />
							</label>
							<br />
							<label>
								Email
								<input id="email" style={inputStyle} name="email" type="email" onChange={this.handleEmailChange} />
							</label>
